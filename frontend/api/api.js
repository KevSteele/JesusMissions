// api.js
import { REACT_NATIVE_APP_STRAPI_URL, REACT_NATIVE_APP_JOSHUA_API_URL, REACT_NATIVE_APP_STRAPI_URL } from '@env';
import axios from 'axios';

// Fetch data from Strapi
export const fetchStrapiData = async () => {
  try {
    const response = await axios.get(`${REACT_NATIVE_APP_STRAPI_URL}/videos`);
